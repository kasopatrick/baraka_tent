...
class Advice : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ad_btn_1.setOnClickListener {
            var uplift = Intent(this,Adv_1::class.java)
            startActivity(uplift)
        }
        ad_btn_2.setOnClickListener {
            var songesha = Intent(this,Adv_2::class.java)
            startActivity(songesha)

        }
        ad_btn_3.setOnClickListener {
            var move = Intent(this,Adv_3::class.java)
            startActivity(move)
        }
        ad_btn_4.setOnClickListener {
            var beba = Intent(this,Adv_4::class.java)
            startActivity(beba)
        }
